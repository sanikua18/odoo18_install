...
echo "Створення користувача бази даних odoo19..."
...
echo "Завантаження Odoo 19..."
sudo rm -rf $ODOO_HOME/* || true
sudo -u $ODOO_USER git clone https://www.github.com/odoo/odoo --depth 1 --branch 19.0 --single-branch $ODOO_HOME/odoo
...
sudo tee $ODOO_HOME/odoo19.conf > /dev/null <<EOF
[options]
...
Type=simple
User=$ODOO_USER
ExecStart=$ODOO_HOME/venv/bin/python3 $ODOO_HOME/odoo/odoo-bin -c $ODOO_HOME/odoo19.conf
Restart=on-failure
RestartSec=10
